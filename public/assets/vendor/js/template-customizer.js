    ...
    (function(t) {
        ...
        198: function(t, e, s) {
            ...
            var l = [
                ...
                m = !!c.contains("layout-menu-collapsed"),
                p = !!c.contains("layout-menu-flipped"),
                ...
                b = (function() {
                    function t(e) {
                        var s = e.cssPath,
                            ...
                            n = e.controls,
                            c = e.defaultTextDir,
                            b = e.defaultLayoutType,
                            v = e.defaultMenuCollapsed,
                            ...
                            if (
                                ((this.settings = {}),
                                    ...
                                    (this.settings.defaultTextDir =
                                        "rtl" === c || h),
                                    (this.settings.defaultLayoutType = b || g),
                        ...
                        (s = [{
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    (this.settings.rtl =
                                        ...
                                        "true" === e :
                                        this.settings.defaultTextDir),
                                    (this.settings.style = -1 !==
                                        this.settings.styles.indexOf(s) ?
                                        s :
                                        this.settings.defaultStyle), -1 ===
                                        ...
                                        this._hasControls("style") ||
                                        (this.settings.style = c.contains(
                                                "dark-style"
                                            ) ?
                                            "dark" :
                                            "light"),
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this._cleanup(),
                                        (this.container =
                                            this._getElementFromString(a.a));
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    for (
                                        var t = 0, e = this._listeners.length; t < e; t++
                                    )
                                        this._listeners[
                                            t
                            ...
                            },
                            {
                                ...
                                value: function(t) {
                                    var e; //! Fix: If horizontal layout and selected layout is semi-dark then set layout default
                                    if (
                                        (document.querySelector(
            ...
            t.exports = function(t, e) {
                ...
                return function(t) {
                    if (
                        ...
                        for (var o = r(t, e), c = 0; c < s.length; c++) {
                            var u = l(s[c]);
                            0 === n[u].references &&
                        ...
                        return this.map(function(e) {
                            var s = (function(t, e) {
                                ...
                                if (e && "function" == typeof btoa) {
                                    ...
                                    return [s].concat(o).concat([a]).join("\n");
                                }
                                var n, l, r;
                                return [s].join("\n");
                            })(e, t);
                            return e[2] ?
                                "@media ".concat(e[2], " {").concat(s, "}") :
                                s;
                        }).join("");
                    }),
                    (e.i = function(t, s, i) {
