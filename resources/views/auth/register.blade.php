                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="mgt_no" type="text" class="form-control @error('mgt_no') is-invalid @enderror" name="mgt_no" value="{{ old('mgt_no') }}" required autocomplete="mgt_no" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="official_registration_date" type="date" class="form-control @error('official_registration_date') is-invalid @enderror" name="official_registration_date" value="{{ old('official_registration_date') }}" required autocomplete="official_registration_date" autofocus>

                                @error('official_registration_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
